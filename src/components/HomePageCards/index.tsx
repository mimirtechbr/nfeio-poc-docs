...
export default function HomePageCards() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-7xl mx-auto w-full px-4 py-15">
            {/*docs*/}
            <WobbleCard
                containerClassName="col-span-1 lg:col-span-3 bg-primary min-h-[400px] lg:min-h-[500px] xl:min-h-[300px]"
            >
            ...
            {/*<WobbleCard containerClassName="col-span-1 min-h-[300px] bg-primary-300">*/}
            {/*    <div>*/}
